...
J = -1 / m * sum(sum(log(prob) .* Y + log(1 - prob) .* (1 - Y)));
...
Theta1_grad = 1 / m * D1 + lambda / m * [zeros(hidden_layer_size, 1) Theta1(:, 2:input_layer_size + 1)];
Theta2_grad = 1 / m * D2 + lambda / m * [zeros(num_labels, 1) Theta2(:, 2:hidden_layer_size + 1)];
